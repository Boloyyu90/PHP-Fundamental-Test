      ...
      <div class="container">
          ...
          <div class="row featurette">
            <div class="col-md-7">
              ...
              <p class="lead">
                  Diciptakan oleh <strong>I Gede Bala Putra</strong>, mahasiswa Universitas Atma Jaya Yogyakarta dari program studi Informatika.
              </p>
              <p class="lead">Nomor Pokok Mahasiswa: <strong>210711320</strong>.</p>
          </div>
          <div class="col-md-5">
              <img
